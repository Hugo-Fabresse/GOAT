...
#define MSG_USAGE(progname) \
    fprintf(stderr, COLOR_BLUE "Usage: %s <command>\n" COLOR_RESET, progname); \
    fprintf(stderr, COLOR_YELLOW "Hint: Available commands are: init\n" COLOR_RESET)
